...
- 错误案例：当正文没有出现 ${}^2$ 和 ${}^{*}$ 的时候在脚注标注 
 <img src="footnote_error_1.png" alt="示例" width="400" style="border: 1px solid #ddd; padding: 5px;"/>
 <img src="footnote_error_2.png" alt="示例" width="400" style="border: 1px solid #ddd; padding: 5px;"/>
### 3. 不要把单独一个词留在一段的最后一行

- 错误示范：
![[lonely_word_error.png]]

### 4. 不要把单独一行留到第二页

- 错误案例：
![[lonely_line_error_1.png]]
![[lonely_line_error_2.png]]
### 5. 页码需要和文章总页数对应

$LaTeX$：需要在`engr1000j-s2.cls`文件中调整

- 错误示范：
 ![[page_number_error.png]]
...
![[subsection_good.png]]
- 错误示范：
<img src="subsection_error_1.png" alt="示例" width="600" style="border: 1px solid #ddd; padding: 5px;"/>
...
![[header_spacing_error_1.png]]
 ![[header_spacing_error_2.png]]
### 7. 每一页文字底部与页脚间距不一致
...
1. 错误点：
	 ...
	 - `615927`缺少前缀
改正：
![[Pasted image 20250701110634.png]]
...
改正：
![[Pasted image 20250701111336.png]]
...
3. 错误点：
	...
	- **使用中文文献**，这是一个不好的习惯
改正：
![[Pasted image 20250701113304.png]]
...
4. 错误点：
	...
	- 期刊名后应该是`,`而不是`.`
	- volume和number应该大写`Vol.`，`No.`
改正：![[Pasted image 20250701113755.png]]
...
5. 错误点：
	...
	- volume和number应该大写`Vol.`，`No.`
改正：
![[Pasted image 20250701114232.png]]
